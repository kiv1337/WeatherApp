        ...
        <div>
            ...
            <div className='flex flex-row w-full justify-between items-center mt-3 px-6'>
                <div className='font-light flex-col text-center justify-center'>
                    ...
                    <p className='text-xs text-[#ffffff66]'>Ощущается как</p> {/* Перевод "Real feel" */}
                </div>
                <div className='font-light flex-col text-center justify-center'>
                    <div className='flex justify-center'>
                        <img src={humid} alt='' />
                    ...
                    <p className='text-xs text-[#ffffff66]'>Влажность</p>
                </div>
                <div className='font-light flex-col text-center justify-center'>
                    <div className='flex justify-center'>
                        <img src={wind} alt='' />
                    </div>
                    <p className='text-sm'>{data.wind.speed} м/с</p>
                    <p className='text-xs text-[#ffffff66]'>Ветер</p>
                </div>
            </div>
        </div>
    );
